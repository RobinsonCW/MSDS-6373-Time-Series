...
df_optiplex <- df_data %>%
    ...
    filter(cat_item == "Dell Latitude 13 5000 Series")
...
e.optiplex = est.arma.wge(df_optiplex_by_week$summary_variable, p=11, q=0)
...
arima.optiplex <- arima(df_optiplex_by_week$summary_variable, order=c(11, 0, 1))
